            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="apartment" class="col-md-4 col-form-label text-md-end">{{ __('Apartment') }}</label>

                            <div class="col-md-6">
                                <input id="apartment" type="text" class="form-control @error('apartment') is-invalid @enderror" name="apartment" required autocomplete="apartment">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="postcode" type="text" class="form-control @error('postcode') is-invalid @enderror" name="postcode" required autocomplete="postcode" pattern="(\d{5}|\d{2}-\d{3}|\d{2}\s\d{3})">
